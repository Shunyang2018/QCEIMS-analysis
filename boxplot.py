...
df = pd.read_excel('/Users/shunyang/Downloads/qceims reference/ppt/tables.xlsx',header = 0, sheet_name = 'Sheet2')
energy = df['number'].tolist()
x = df['index'].tolist()
...
ax = df.plot(x='number',y='Cos', kind = 'scatter',ax=axes, linewidths=0.2, fontsize=10)
plt.grid(ls = '--')
